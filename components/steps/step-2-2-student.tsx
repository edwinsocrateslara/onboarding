...
const OPTIONS: Q2Option[] = [
  { key: "a", label: "I want to find an internship or part-time job"                           },
  { key: "b", label: "I want to build skills for my future career"                             },
  { key: "c", label: "I'm not sure yet — I'd like to explore what careers are out there for me" },
]
...
export function Step22Student({ onAdvance }: Props) {
  return (
