...
export function Step23Education({
  ...
  const [revealed,          setRevealed]          = useState(initialEducationLevel !== "")
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <SelectField
          value={level}
          onChange={v => { setLevel(v); setRevealed(true) }}
      ...
      {/* Progressive disclosure — revealed once education level is selected */}
      <div
        style={{
